    ...
    public InteractionResult use(Level p_41190_, Player p_41191_, InteractionHand p_41192_) {
        ...
        if (p_41190_ instanceof ServerLevel serverlevel) {
            if (p_41191_.getAttributes().getValue(AttributeRegistry.MANA) >= 100) {
                ...
                p_41190_.playSound((Player) null, p_41191_.getX(), p_41191_.getY(), p_41191_.getZ(), SoundEvents.GENERIC_EXPLODE, SoundSource.NEUTRAL, 0.5F, 0.4F / (p_41190_.getRandom().nextFloat() * 0.4F + 0.8F));
                p_41191_.getAttributes().getInstance(AttributeRegistry.MANA).setBaseValue(p_41191_.getAttributes().getValue(AttributeRegistry.MANA) - 100);
